...
abstract class BaseRepository
{
    ...
    public function whereFirst(array $search = [], int $skip = null, int $limit = null){
    ...
    public function creatOrUdate(array $input){
        
        // if (isset($input['id'])){

            if(empty( $this->find($input["id"]))){ 

                return $this->create($input);
     
             }else{
     
                 return $this->update($input,$input["id"]);
