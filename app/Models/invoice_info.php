...
{
    use SoftDeletes, HasFactory,HasUuids,UsesTenantConnection;
    
    public $incrementing = false;

    protected $keyType = 'string';

    public $table = 'invoice_infos';
    ...
    public static array $rules = [
        'title' => 'required',
        'category_uid' => ['required', 'string', 'exists:App\Models\invoice_category_info,id'],
        'uid' => 'required'
    ]; 
