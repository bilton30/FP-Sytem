<template>
  <app>
    <q-page class="q-pa-sm">
      ...
      <table-actions :data="users" :columns="table.columns" @action="performAction" tableName="Users" buttonName="New User"
        class="q-mt-lg  border"></table-actions>
      <q-dialog ref="dialogRef" @hide="onDialogHide">
        <q-card class="q-dialog-plugin" style="width: 700px; max-width: 80vw;">
            ...
            <q-card class="card-bg text-white no-shadow" bordered>
              ...
              <q-card-section class="q-pa-sm">
                <q-list class="row">
                  ...
                  <q-item class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <q-item-section>
                      <q-input dark color="white" dense v-model="editedItem.email" label="Email *"
                  ...
                  <q-item class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <q-item-section>
                      <q-input dark color="white" dense v-model="editedItem.newPassword" label=" New Password *"
                  ...
                  <q-item class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <q-item-section>
                      <q-input dark color="white" dense v-model="editedItem.confirmPassword"
                        label=" Confirme New Password *" :type="isPwd.confirme ? 'password' : 'text'"
                        :rules="[val => val && val.length > 0 || 'Please confirme New Password']">
                        <template v-slot:append>
          ...
          <q-card-actions align="right">
            ...
            <q-btn :disable="loading" class="text-capitalize bg-info text-white" label="Update Info"
              @click="onOKClick(); loading = true">
              <div v-if="loading">
