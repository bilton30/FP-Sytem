<template>
  <app>
    <q-page class="q-pa-sm">
      ...
      <table-actions :data="roles" :columns="table.columns" @action="performAction" tableName="roles"
              ...
              <q-card-section class="q-pa-sm">
                ...
                <q-list class="row">
                  <q-item class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <q-item-section>
                      <q-input dark color="white" dense v-model="editedItem.name" label="Role Name *" lazy-rules
                        :rules="[val => val && val.length > 0 || 'Please type role name']" style="margin-top: 15px;" />
                    </q-item-section>
                  </q-item>
                  <q-item class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <q-item-section>
                      <q-select fill v-model="editedItem.guard_name" :options="guard_name" label="Guard Name *"
      ...
      <q-dialog ref="dialogShow" @hide="close">
        <q-card class="q-dialog-plugin" style="width: 500px; max-width: 80vw;" ref="dialogContainer">
          ...
          <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
            <q-card class="card-bg text-white no-shadow" bordered>
              <q-card-section class="text-h6 ">
                <div class="text-h6">Show Roles</div>
                <!-- <div class="text-subtitle2">Complete profile</div> -->
              </q-card-section>
              <q-card-section class="q-pa-sm">
                <q-list class="row">
                  <q-item class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <q-item-section>
                      <q-input dark color="white" dense v-model="editedItem.name" disable label="Role Name *" lazy-rules
                        :rules="[val => val && val.length > 0 || 'Please type role name']" style="margin-top: 15px;" />
                    </q-item-section>
                  </q-item>
                  <q-item class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <q-item-section>
                      <q-select fill v-model="editedItem.guard_name" disable :options="guard_name" label="Guard Name *"
                        @update:model-value="selectGuard(editedItem.guard_name)"
                        :rules="[val => val && val.length > 0 || 'Please type guard name : api ou web']" />
                      <!-- <q-input dark color="white" dense v-model="editedItem.guard_name"  label="Guard Name *" value="web"
                        :rules="[val => val && val.length > 0 || 'Please type guard name : api ou web']" /> -->
